...
const skills = [
  {title: 'AWS', description: 'EC2, S3, RDS, CloudFront, VPC, IAM, CloudFormation, Lambda'},
  {title: 'Containers', description: 'Docker, Kubernetes (k3s), Helm, Docker Compose'},
  {title: 'Linux', description: 'Ubuntu, Amazon Linux, systemd, Bash scripting'},
  {title: 'Networking', description: 'TCP/IP, DNS, subnetting, VPN, firewalls, load balancing'},
  {title: 'CI/CD', description: 'GitHub Actions, automated deployments, IaC pipelines'},
  {title: 'Monitoring', description: 'CloudWatch, Prometheus, Grafana, alerting'},
];
